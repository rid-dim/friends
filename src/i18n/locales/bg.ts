...
export const bg = {
  ...
  migrationNoticeAcknowledge: 'Разбирам',
  migrationNoticeMessage: 'Вашият акаунт беше мигриран към нова версия. От съображения за сигурност и съвместимост списъкът с приятели и публичните идентификатори бяха изчистени. Моля, добавете отново приятелите и публичните идентификатори.',
  migrationNoticeTitle: 'Необходима е миграция: моля, добавете отново приятелите и публичните идентификатори',
  ...
  partner: 'Партньор:',
  paymentFailureMessage: 'Техническа грешка при плащане. Моля, проверете дали имате достатъчно AUTONOMI / ETH(Arbitrum) токени или дали таксите за газ в Arbitrum са твърде високи. Ако проблемът продължава, свържете се с разработчика.',
  paymentFailureTitle: 'Грешка при плащане',
  ...
  regenerateKey: 'Генериране на нов ключ',
  reload: 'Презареждане',
