...
export const fr = {
  ...
  migrationNoticeAcknowledge: 'J\'ai compris',
  migrationNoticeMessage: 'Votre compte a été migré vers une nouvelle version. Pour des raisons de sécurité et de compatibilité, votre liste d\'amis et vos identifiants publics ont été vidés. Veuillez réajouter vos amis et identifiants publics.',
  migrationNoticeTitle: 'Migration requise : veuillez réajouter les amis et identifiants publics',
  ...
  partner: 'Partenaire:',
  paymentFailureMessage: 'Veuillez vérifier si vous avez suffisamment de tokens AUTONOMI / ETH(Arbitrum) sur votre DWEB_SECRET_KEY configuré. Les frais de gaz DWEB standard sont de 0,2 Gwei. Si les frais de transaction Arbitrum actuels dépassent 0,2 Gwei (vérifiez https://arbiscan.io/blocks), les téléchargements de données, la création d\'ID public et les demandes d\'ami peuvent échouer.',
  paymentFailureTitle: 'Échec de paiement - Fonds insuffisants ou frais de gaz élevés',
