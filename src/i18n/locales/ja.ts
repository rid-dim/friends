...
export const ja = {
  ...
  migrationNoticeAcknowledge: '理解しました',
  migrationNoticeMessage: 'アカウントは新しいバージョンに移行されました。セキュリティと互換性のため、友達リストと公開識別子はクリアされました。友達と公開識別子を再追加してください。',
  migrationNoticeTitle: '移行が必要です：友達と公開識別子を再追加してください',
  ...
  originalMessage: '原文:',
  partner: 'パートナー:',
  paymentFailureMessage: '支払いエラーが発生しました。AUTONOMI / ETH(Arbitrum) トークンが十分か、Arbitrum のガス料金が高すぎないか確認してください。問題が続く場合は開発者に連絡してください。',
  paymentFailureTitle: '支払いエラー',
