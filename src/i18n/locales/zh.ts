...
export const zh = {
  ...
  migrationNoticeAcknowledge: '我已了解',
  migrationNoticeMessage: '您的账户已迁移到新版本。出于安全和兼容性考虑，您的好友列表和公共标识符已被清空。请重新添加好友和公共标识符。',
  migrationNoticeTitle: '需要迁移：请重新添加好友和公共标识符',
  ...
  originalMessage: '原文:',
  partner: '伙伴:',
  paymentFailureMessage: '支付错误。请检查您的 AUTONOMI / ETH(Arbitrum) 代币是否充足，或 Arbitrum 燃气费是否过高。如果问题持续存在，请联系开发者。',
  paymentFailureTitle: '支付错误', 
