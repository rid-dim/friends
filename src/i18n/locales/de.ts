...
export const de = {
  ...
  language: 'Sprache',
  lastSeenAt: 'zuletzt gesehen am: {ts}',
  lastSeenHours: 'zuletzt gesehen vor {n} Stunden',
  lastSeenMinutes: 'zuletzt gesehen vor {n} Minuten',
  lastSeenUnknown: 'zuletzt gesehen: unbekannt',
  ...
  migrationNoticeAcknowledge: 'Verstanden',
  migrationNoticeMessage: 'Dein Konto wurde auf eine neue Version migriert. Aus Sicherheits- und Kompatibilitätsgründen wurden deine Freundesliste und öffentlichen Kennungen geleert. Bitte füge deine Freunde und öffentlichen Kennungen erneut hinzu.',
  migrationNoticeTitle: 'Migration erforderlich: Bitte Freunde und öffentliche Kennungen neu hinzufügen',
  ...
  paymentFailureMessage: 'Bitte prüfen Sie, ob Sie ausreichend AUTONOMI / ETH(Arbitrum) Token auf Ihrem konfigurierten DWEB_SECRET_KEY haben. Die Standard DWEB Gas-Gebühr beträgt 0,2 Gwei. Wenn die aktuellen Arbitrum Transaktionsgebühren 0,2 Gwei übersteigen (prüfen Sie https://arbiscan.io/blocks), können Daten-Uploads, öffentliche ID-Erstellungen und Freundschaftsanfragen fehlschlagen.',
  paymentFailureTitle: 'Zahlungsfehler - Unzureichende Mittel oder Hohe Gas-Gebühren',
  ...
  walletNotFound: 'Wallet-Informationen nicht verfügbar',
