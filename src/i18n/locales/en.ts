...
export const en = {
  ...
  partner: 'Partner:',
  paymentFailureMessage: 'Please check if you have sufficient AUTONOMI / ETH(Arbitrum) tokens on your configured DWEB_SECRET_KEY. The standard DWEB gas fee is 0.2 Gwei. If current Arbitrum transaction fees exceed 0.2 Gwei (check https://arbiscan.io/blocks), data uploads, public ID creation, and friend request creation may fail.',
  ...
  showOfflineFriends: 'Offline friends',
