export const translations = {
  ...
  es: {
    ...
    enterDatamapAddress: 'Introducir dirección datamap',
  ...
  bg: {
    ...
    enterDatamapAddress: 'Въведете datamap адрес',
    ...
    friendPeerId: 'Peer ID на приятел',
    enterPeerId: 'Въведете Peer ID',
    friendName: 'Име на приятел',
    ...
    sendFriendRequest: 'Изпрати заявка за приятелство',
    acceptFriendRequest: 'Приемане на заявка за приятелство',
    friendRequestSent: 'Заявка за приятелство изпратена',
    friendRequestAccepted: 'Заявка за приятелство приета',
    newFriendRequests: 'Нови заявки за приятелство',
    loading: 'Зареждане...',
    sending: 'Изпращане...',
    back: 'Назад',
    cancel: 'Отказ',
    addNewFriend: 'Добави нов приятел',
    loadProfile: 'Зареди профил',
  ...
  ja: {
    ...
    enterDatamapAddress: 'datamapアドレスを入力',
    themeUrl: 'テーマURL',
    ...
    addFriend: '友達を追加',
    removeFriend: '友達を削除',
    friendPeerId: '友達のPeer ID',
    enterPeerId: 'Peer IDを入力',
    friendName: '友達の名前',
    ...
    acceptFriendRequest: '友達申請を承認',
    friendRequestSent: '友達申請が送信されました',
    ...
    errorSendingRequest: '友達申請の送信エラー',
    errorAcceptingRequest: '友達申請の承認エラー',
  ...
  ko: {
    ...
    enterDatamapAddress: 'datamap 주소 입력',
    themeUrl: '테마 URL',
  ...
  zh: {
    ...
    profileImage: '个人头像',
    enterDatamapAddress: '输入datamap地址',
    themeUrl: '主题URL',
    ...
    addNewFriend: '添加新好友',
    loadProfile: '加载用户资料',
    profilePreview: '用户资料预览',
    profileNotFound: '未找到用户资料',
    errorLoadingProfile: '加载用户资料时出错',
    errorSendingRequest: '发送好友请求时出错',
    errorAcceptingRequest: '接受好友请求时出错',
